...
function Pessoa(pnome, pidade) {//Definição da classe Carro com um construtor que aceita um parâmentro "pnome"
    ...
    this.getIdade=function() {//Método par aobter a idade da pessoa
        return this.idade
    },
    ...
    this.setIdade=function(idade) {//Método para definir a idade da pessoa
        return this.idade
    },
