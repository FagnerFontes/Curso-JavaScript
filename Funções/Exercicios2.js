...
const resultadoSoma = soma(25, 78);
...
function somarArray(array) {
  //Declara uma função chamada somarArray, tendo parâmetros os elemntos do array
  let soma = 0; //Inicia a variável soma em 0
  for (let i = 0; i < array.length; i++) {
    //Inicia um laço para contar os elementos dos array
    //Abaixo a variavel soma
    soma += array[i]; //
  }
...
function palavra(string) {
  //Inicia uma função chamada "palavra"
...
const resulta = parImpar(13);
//console.log(parImpar());

console.log("===================Exer5================");

function filtrarNumerosPares(vetor) {
  //Declaração da função filtrarNumerosPares, que recebe um vetor como parâmetro
